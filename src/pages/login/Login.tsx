        ...
        <>
            <div className="h-screen place-items-center font-bold bg-[#D93937]">
                ...
                <form className="flex justify-center items-center flex-col w-full gap-6" onSubmit={login}>
                    <h2 className="text-[#D93937] text-5xl">Entrar</h2>
                    ...
                    <button
                        type='submit'
                        className="rounded bg-[#D93937] flex justify-center
                                   hover:bg-[#F35654] text-white w-1/2 py-2">
                    ...
                    <p>
                        ...
                        <Link to="/cadastro" className="text-[#D93937] hover:underline">
                            Cadastre-se
                        </Link>
                    </p>
                </form>
